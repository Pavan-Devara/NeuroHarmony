...
object SuspendChatRepository {
     ...
     * Login
     */
    fun suspendchatrepo( user_key: String, action_type: Int,onResult:  (isSuccess: Boolean, response: SuspendChatResponse?) -> Unit) {

        scope.launch {
            NotificationApiService.instance.suspendchatinterface(
                SuspendChatRequest(
