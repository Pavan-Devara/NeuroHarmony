...
import com.neuro.neuroharmony.data.repository.DownloadPdfRepository
...
class DownloadPdfViewModel: ViewModel() {
    ...
    var loginResponseLiveData = MutableLiveData<DownloadPdfResponse>() // live data for getting Login response
    ...
    fun downloadpdfvm() {
        if (NeuroHarmonyApp.getInstance()!!.isConnected!!) {
            ...
            DownloadPdfRepository.downloadpdf() { isSuccess, response ->
