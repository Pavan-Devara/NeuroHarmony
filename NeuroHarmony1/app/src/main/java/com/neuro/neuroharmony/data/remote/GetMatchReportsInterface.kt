...
interface GetMatchReportsInterface {

    @GET("/match/match-report-v1/?")
    fun getmatchedreports( @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<GetMatchedReportsOfUserResponse>
    ...
    companion object {
        val instance: GetMatchReportsInterface by lazy {
            ...
            if (BuildConfig.DEBUG) {
                ...
                val requestInterceptor = Interceptor { chain ->
                    val url = chain.request()
                        .url()
                        .newBuilder()
                        .addPathSegment(PrefsHelper().getPref("matched_user"))
                        .addPathSegment("/")
                        .build()
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(GetMatchReportsInterface::class.java)
        }
