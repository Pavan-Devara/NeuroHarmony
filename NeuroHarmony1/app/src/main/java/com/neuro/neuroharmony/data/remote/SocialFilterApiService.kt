...
import com.neuro.neuroharmony.data.model.SocialFilter.SocialFilterSubmitRequest
...
interface SocialFilterApiService {

    @GET("/user/social-filter/")
    fun socialfilterchoices( @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<SocialFilterResponse>

    @POST("/user/social-filter/")
    fun socialfiltersubmit(@Body NeuroHarmonyApp: SocialFilterSubmitRequest,
                           @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<SocialFilterSumitResponse>




    companion object {
        val instance: SocialFilterApiService by lazy {
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(SocialFilterApiService::class.java)
        }
