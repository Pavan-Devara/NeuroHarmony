...
class PrefsHelper {
    ...
    private var context: Context = NeuroHarmonyApp.getInstance()._context!!
    ...
    val prefsFileRemember = NeuroHarmonyApp.getInstance()._context!!.packageName + "rem"
    val prefsFile = NeuroHarmonyApp.getInstance()._context!!.packageName
