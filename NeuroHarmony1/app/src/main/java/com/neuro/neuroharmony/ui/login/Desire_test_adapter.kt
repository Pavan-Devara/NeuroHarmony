...
class Desire_test_adapter(val userlist1: ArrayList<DesireIntroScreen.User>) : RecyclerView.Adapter<Desire_test_adapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val user: DesireIntroScreen.User = userlist1[position]
