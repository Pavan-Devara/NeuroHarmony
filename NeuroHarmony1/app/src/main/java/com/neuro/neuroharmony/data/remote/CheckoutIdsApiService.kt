...
interface CheckoutIdsApiService {


    @POST("/payment/verify/")
    fun checkoutids(@Body requestBodyMap: CheckoutIdsRequest, @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<CheckoutIdsResponse>

    @POST("/payment/fail/")
    fun logerrorpayment(@Body requestBodyMap: ErrorCodeAndDescriptionRequest, @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<ErrorCodeAndErrorDescriptionResponse>




    companion object {
        val instance: CheckoutIdsApiService by lazy {
