...
interface GetInitailNeuroMatchApiService {


    @GET("/match/neuro-match-v2/?")
    fun getinitailmatchresults( @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<ShowInitailNeuroMatchResponse>
    ...
    companion object {
        val instance: GetInitailNeuroMatchApiService by lazy {
            ...
            if (BuildConfig.DEBUG) {
                ...
                val requestInterceptor = Interceptor { chain ->
                    val url = chain.request()
                        .url()
                        .newBuilder()
                        .addPathSegment(PrefsHelper().getPref("userKey"))
                        .addPathSegment("/")
                        .build()
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(GetInitailNeuroMatchApiService::class.java)
        }
