...
object RevokeChatInterestRepository {
     ...
     * Login
     */
    fun revokechatinterest( receiver_key: Int, action_type: Int,onResult:  (isSuccess: Boolean, response: RevokeInterestResponse?) -> Unit) {

        scope.launch {
            NotificationApiService.instance.revokechatinterestinterface(
