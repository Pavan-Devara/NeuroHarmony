...
interface DownloadPdfApiService {
    ...
    @GET("/report/download/?")
    fun downloadpdf( @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<DownloadPdfResponse>
    ...
    companion object {
        val instance: DownloadPdfApiService by lazy {
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(DownloadPdfApiService::class.java)
        }
