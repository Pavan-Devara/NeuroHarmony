...
interface PushNotificationAPIService {
    @POST("/notification/device-info/")
    fun fcmtoken(@Body requestBodyMap: NotificationRequest, @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<NotificationResponse>

    @GET("/notification/notification-list/")
    fun notificationlist(@Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<ListofNotificationsResponse>


    @PUT("notification/notification-status/{id}/")
    fun readnotification(
        @Path(
            value = "id",
            encoded = true
        ) id: String?,
        @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<LifestyleInfoSubmitResponse>


    @DELETE("notification/device-info/{id}/")
    fun delete_token(
        @Path(
            value = "id",
            encoded = true
    ...
    companion object {
        val instance: PushNotificationAPIService by lazy {
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(PushNotificationAPIService::class.java)
        }
