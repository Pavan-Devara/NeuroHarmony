...
interface ActiveSessionsOfUser {

    @GET("/test/score/?")
    fun getActiveSessions( @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<AllSessionOfUserResponse>

    companion object {
        val instance: ActiveSessionsOfUser by lazy {
            ...
            if (BuildConfig.DEBUG) {
                ...
                val requestInterceptor = Interceptor { chain ->
                    val url = chain.request()
                        .url()
                        .newBuilder()
                        .addPathSegment(PrefsHelper().getPref<String>("userKey"))
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(ActiveSessionsOfUser::class.java)
        }
