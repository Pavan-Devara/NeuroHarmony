...
interface GetScoreApiService {

    @GET("/test/score/?")
    fun getneurodesirescore( @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<GetNeuroDesireScoreResponse>

    @GET("/test/score/?")
    fun getcorebeliefscore( @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<GetCoreBeliefScoreResponse>
    ...
    * */
    companion object {
        val instance: GetScoreApiService by lazy {
            ...
            if (BuildConfig.DEBUG) {
                ...
                val requestInterceptor = Interceptor { chain ->
                    val url = chain.request()
                        .url()
                        .newBuilder()
                        .addQueryParameter("session_id", PrefsHelper().getPref("sessionId"))
                        .addQueryParameter("test_type" ,PrefsHelper().getPref("test_type"))
                        .build()
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(GetScoreApiService::class.java)
        }
