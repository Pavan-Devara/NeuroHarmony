...
interface AffiliateOrgApiService {

    @POST("/user/affiliate//v1/")
    fun affiliateformOrg(@Body NeuroHarmonyApp: AffiliateOrgFormRequest, @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token") ): Call<AffiliateOrgFormResponse>
    ...
    companion object {
        val instance: AffiliateOrgApiService by lazy {
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(AffiliateOrgApiService::class.java)
        }
