...
interface BioSubmitApiService {

    @POST("/user/personal-info_v1/?")
    fun profileinfo(@Body NeuroHarmonyApp: ProfileInfoRequest, @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token") ): Call<ProfileInfoResponse>
    ...
    companion object {
        val instance: BioSubmitApiService by lazy {
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(BioSubmitApiService::class.java)
        }
