...
import com.neuro.neuroharmony.data.model.AffiliateWorkflow.AffiliateFormRequest
...
interface AffiliateApiService {
    ...
    @POST("/user/affiliate/v1/")
    fun affiliateform(@Body NeuroHarmonyApp:AffiliateFormRequest , @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token") ): Call<AffiliateFormResponse>

    @GET("/user/affiliate/v1/")
    fun getaffliatedetails( @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<GetAffiliateDetailsResponse>

    @GET("/user/affiliate-transactions-v1/")
    fun getaffliatetransactions( @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<GetAffiliateRefferalTransactions>




    companion object {
        val instance: AffiliateApiService by lazy {
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(AffiliateApiService::class.java)
        }
