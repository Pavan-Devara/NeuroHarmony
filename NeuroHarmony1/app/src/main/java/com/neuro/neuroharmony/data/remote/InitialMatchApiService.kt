...
interface InitialMatchApiService {


    @POST("/match/neuro-match-v2/")
    fun initiatematch(@Body NeuroHarmonyApp: InitiateMatchRequest, @Header("Authorization") token: String = "Token " + PrefsHelper().getPref("Token")): Call<InitiateMatchResponse>
    ...
    companion object {
        val instance: InitialMatchApiService by lazy {
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(InitialMatchApiService::class.java)
        }
